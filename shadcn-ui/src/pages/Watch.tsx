                                ...
                                {audioTracks.map((track, index) => (
                                  <button
                                    ...
                                    onClick={async (e) => {
                                      ...
                                      const jellyfinIndex = track.index;
                                      
                                      console.log('[AUDIO] Switching audio track:', {
                                        index,
                                        jellyfinIndex,
                                        track: track.name,
                                        currentTime,
          ...
          <div className="mb-8">
            <div className="flex flex-wrap gap-3 mb-6">
              {media.genres.map((genre) => (
                <span
                  key={genre}
                  className="px-3 py-1.5 bg-white/10 text-white/90 rounded-full text-sm font-medium backdrop-blur-sm border border-white/20"
                >
                  {genre}
                </span>
              ))}
